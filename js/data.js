...
window.TRIP = {
  ...
  */
  places: {
    ...
    khaosoi:     { n: "Khao Soi Mae Sai 泰北咖喱面", q: "Khao Soi Mae Sai Chiang Mai ข้าวซอยแม่สาย", rating: 4.4, price: "฿", pnote: "米其林指南多年推荐 · 牛肉面 55฿ · 评分各来源 4.2–4.6", hours: [[], [S(D(8), D(16))], [S(D(8), D(16))], [S(D(8), D(16))], [S(D(8), D(16))], [S(D(8), D(16))], [S(D(8), D(16))]] },
    kiewkaika:   { n: "Kiew Kai Ka（One Nimman）", q: "Kiew Kai Ka One Nimman Chiang Mai", rating: 4.5, price: "฿฿", pnote: "米其林指南推荐 · 黄咖喱软壳蟹", hours: WEEK([S(D(11), D(22))]) },
    gingerfarm:  { n: "Ginger Farm Kitchen（One Nimman）", q: "Ginger Farm Kitchen One Nimman Chiang Mai", rating: 4.5, price: "฿฿", pnote: "米其林指南 · 招牌脆皮五花 · 人均约 300฿", hours: WEEK([S(D(10), D(22))]) },
    changthong:  { n: "Changthong Heritage Park 遗产公园", q: "Changthong Heritage Park Chiang Mai", rating: null, price: "฿฿", pnote: "古树活体博物馆 · 外国人 250฿ · 开放时间各来源不一，出发前电话确认", hours: WEEK([S(D(9), D(18))]) },
  },
  ...
  days: [
    ...
    },
    {
      ...
      items: [
        ...
        { t: "12:00–13:30", e: "🍜", ti: "午餐：酒店步行圈高分餐厅三选一",
          de: "都在酒店 10 分钟步行圈内：①Khao Soi Mae Sai 泰北咖喱面（米其林推荐，只开到 16:00，想吃趁中午）②Kiew Kai Ka（米其林指南泰餐）③Ginger Farm Kitchen（农场到餐桌）", tags: ["美食"], place: "khaosoi", place2: "kiewkaika", place3: "gingerfarm" },
    ...
    },
    {
      ...
      title: "市场日 · JJ 集市 · 遗产公园", ov: "Jing Jai 集市 · Changthong 公园",
      items: [
        ...
        { t: "14:00–16:30", e: "🌳", ti: "Changthong Heritage Park 遗产公园",
          de: "从 JJ/Chef Den 一带继续向北约 15 分钟车程（顺路不回城）：30 莱古树活体博物馆 + 苔藓花园 + 瀑布 + Spiral Coco 咖啡馆 · 外国人门票 250฿ · 开放时间各来源不一（一说 16:30 止票、一说 19:00 闭园），出发前电话确认", tags: [], place: "changthong" },
        { t: "17:00–18:30", e: "🏨", ti: "回酒店休整",
          de: "躲过午后雷阵雨回酒店歇脚", tags: [] },
        { t: "18:30–21:00", e: "🍜", ti: "宁曼路晚餐 · 自由安排",
          de: "酒店周边任选：Khao Soi Mae Sai 之外的街边小吃 / One Nimman 餐厅，顺便补手信", tags: ["可选", "美食"] },
        { t: "21:30", e: "🎒", ti: "回酒店打包",
          de: "明早班机，行李提前收好", tags: [] },
      ],
    },
  ...
  foods: [
    ...
    { e: "🥩", n: "Ancient Beef Thai Cuisine", area: "古城东侧 · 长康路（Night Bazaar 旁）", when: "10/4 午餐备选",
      ...
      linkT: "地图" },
    { e: "🍜", n: "Khao Soi Mae Sai 泰北咖喱面", area: "酒店北侧步行约 10 分钟", when: "10/1 午餐",
      note: "米其林指南多年推荐 · 牛肉面 55฿ · 周一至周六 08:00–16:00 · 周日休", place: "khaosoi",
      link: "https://www.google.com/maps/search/Khao+Soi+Mae+Sai+Chiang+Mai",
      linkT: "地图" },
  ],
};
