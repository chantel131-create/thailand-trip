    ...
    },
    {
      ...
      items: [
        ...
        { t: "13:30–15:00", e: "🚶", ti: "宁曼路扫街（同片区步行串联）",
          de: "Lot of Taste 下午茶 → 榴莲仙人（宁曼路榴莲专门店），全程步行，中途不回酒店", tags: ["美食"], place: "lot", place2: "durian" },
    ...
    },
    {
      ...
      items: [
        ...
        { t: "12:00–13:30", e: "🦐", ti: "午餐 Chef Den Seafood",
          de: "就在 JJ 集市旁，步行约 550 米 ★ 若当日休店（周日休店说法不一，建议提前电话确认）则改吃 JJ 市集摊位", tags: ["美食"], place: "chefden" },
