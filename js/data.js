...
window.TRIP = {
  ...
  */
  places: {
    ...
    chefden:     { n: "Chef Den Seafood 海鲜", q: "Chef Den Seafood Chiang Mai", rating: 4.4, price: "฿฿", pnote: "人均 101–250฿ · 休日说法不一", hours: WEEK([S(D(11), D(22))]) },
  ...
  trainTt: [
    ...
    { t: "14:30", e: "🚶", ti: "步行至 MRT 素坤逸站",
      de: "约 5–8 分钟", tag: "地铁方案", place: "mrt_sukhumvit" },
    { t: "14:40", e: "🚇", ti: "蓝线 → Kamphaeng Phet 站（10 站）",
      de: "约 30 分钟 · 无需换乘 · 不受堵车影响", tag: "地铁方案" },
    { t: "15:10", e: "👗", ti: "抵达古着市场",
      de: "Kamphaeng Phet 站 1 号口步行约 3 分钟", tag: "购物", place: "bangsue" },
    { t: "15:15–17:15", e: "🛍️", ti: "Bang Sue Junction 古着市场",
      de: "6 层古着/复古天堂 · 周三正常营业（10:00–20:00）★ 免费入场", tag: "购物" },
    { t: "17:15", e: "🚇", ti: "回地铁，2 站到 Bang Sue",
      de: "约 5 分钟，阿披瓦车站与 Bang Sue 站无缝衔接", tag: "地铁方案" },
    { t: "17:25", e: "🚉", ti: "抵达阿披瓦中央车站",
      de: "进站，找 9 次列车站台", tag: "候车", place: "aphiwat" },
    { t: "17:45", e: "🎫", ti: "进站候车完毕",
      de: "官方建议提前 30 分钟以上到站，我们留足 1 小时", tag: "候车" },
    { t: "18:40", e: "🚂", ti: "红丝绒夜火车发车",
      de: "晚餐可上餐车或提前打包便当", tag: "发车" },
  ...
  days: [
    ...
    },
    {
      ...
      items: [
        ...
        { t: "14:00", e: "🧳", ti: "退房出发（见下方火车时间表）",
          de: "之后按「红丝绒火车」时间表走：地铁 → 古着市场 → 进站", tags: ["交通"], place: "hotel_bkk" },
        { t: "18:40", e: "🚂", ti: "红丝绒夜火车发车",
    ...
    },
    {
      ...
      items: [
        ...
        { t: "14:00–15:30", e: "☕", ti: "Lot of Taste 下午茶",
          de: "宁曼路精品咖啡（08:00–22:00）· 招牌 Soft Latte + 冰淇淋甜点", tags: ["美食"], place: "lot" },
        { t: "16:00–18:00", e: "💆", ti: "Relax Express 按摩",
          de: "古城塔佩门店（10:00–24:00）· 舟车劳顿后回血 · 建议提前 1 天在 Klook 预约", tags: ["提前预约"], place: "relax" },
        { t: "18:00–19:30", e: "🛁", ti: "回酒店办理入住 · 洗漱换装",
          de: "休整一下再去吃大餐", tags: ["住宿"] },
        { t: "20:00", e: "🍽️", ti: "PARI- 晚餐（已订 8 点）",
          de: "古城三兰路 · 米其林指南日式居酒屋 · 宁曼打车约 10 分钟，建议 19:45 前到店", tags: ["已预订", "美食"], place: "pari" },
        { t: "22:00", e: "🌙", ti: "回酒店休息",
          de: "晚安清迈", tags: [] },
      ],
    },
    {
      ...
      items: [
        ...
        { t: "19:00–20:30", e: "🦐", ti: "晚餐 Chef Den Seafood",
          de: "古城附近人气海鲜排档 · 周三/周日休店说法不一，周五安全", tags: ["美食"], place: "chefden" },
        { t: "21:00", e: "🍢", ti: "可选夜宵：Pum Deng 麻辣烫",
          de: "玛雅附近（17:30–24:00）· 麻辣烫 + 关东煮 + 烤串 · 看胃容量", tags: ["可选", "美食"], place: "pumdeng" },
      ],
    },
    {
      ...
      title: "咖啡 · 清迈大学 · 后门夜市",
      items: [
        { t: "10:00", e: "🥐", ti: "自然醒 brunch",
          de: "宁曼路任选", tags: [] },
        { t: "11:00–12:30", e: "☕", ti: "咖啡制作体验课（已订 · Klook）",
          de: "亲手冲煮/拉花 + 品尝自己做的咖啡，一般 1.5–2 小时；具体场次以 Klook 凭证为准（小程序凭证：#小程序://KLOOK客路/1WB2NLZQiOXeg0B，微信内打开）。课后正好接清迈大学行程", tags: ["已预订"] },
        { t: "13:30–15:30", e: "🎓", ti: "清迈大学",
          de: "宁曼向西北 Grab 约 10–15 分钟 · 逛校园、静心湖、素贴路街区", tags: [], place: "cmu" },
        ...
        { t: "20:30", e: "🛍️", ti: "回宁曼散步消食",
          de: "One Nimman / 玛雅商场", tags: ["可选"], place: "onenimman" },
      ],
    },
    {
      ...
      items: [
        ...
        { t: "12:00–13:30", e: "🍜", ti: "午餐",
          de: "JJ 市集内 / 宁曼路", tags: ["美食"] },
        { t: "14:30–16:30", e: "💄", ti: "玛雅商场扫货",
          de: "eveandboy 彩妆（2 楼）+ 宁曼路小店 · 顺路尝宁曼路榴莲仙人（攻略二选一）", tags: ["购物"], place: "eveandboy", place2: "durian" },
  ...
  foods: [
    ...
    { e: "🥔", n: "后门夜市炸土豆", area: "清迈大学后门夜市", when: "10/3 小吃",
      ...
      linkT: "小红书攻略" },
    { e: "🍢", n: "Pum Deng Mala", area: "玛雅附近 · Jed Yod 路", when: "10/2 夜宵（备选）",
    ...
    { e: "🍽️", n: "PARI-", area: "古城三兰路", when: "10/1 20:00 · 已订",
      ...
      linkT: "地图" },
    { e: "🦐", n: "Chef Den Seafood", area: "古城附近", when: "10/2 晚餐",
      note: "人气海鲜排档 · 咖喱软壳蟹 / 咸蛋黄鱿鱼", place: "chefden",
      ...
      linkT: "地图" },
    { e: "🍦", n: "榴莲仙人", area: "宁曼路", when: "10/4 下午",
      ...
      linkT2: "攻略②" },
    { e: "💄", n: "eveandboy", area: "玛雅商场 2 楼", when: "10/4 下午",
    ...
    { e: "👗", n: "1981 Soul & Sold", area: "曼谷 · 蓝甘杏路 15 巷", when: "9/30 上午",
      ...
      linkT: "攻略" },
    { e: "🛍️", n: "Bang Sue Junction 古着市场", area: "曼谷 · 恰图恰对面（红楼）", when: "9/30 下午",
      note: "6 层古着 · 一至四 10:00–20:00 · 五六日到 21:00 · 免费入场", place: "bangsue",
      link: "https://www.tripadvisor.com/Attraction_Review-g293916-d22831484-Reviews-Bangsue_Junction_Shopping_Center-Bangkok.html",
      linkT: "攻略" },
  ],
};
